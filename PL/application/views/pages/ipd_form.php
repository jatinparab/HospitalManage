			    ...
			    <div class="col-md-10 col-sm-offset-1">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            <form action="<?=base_url()?>Ipd/formSubmit" method="post" class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Sr No.</label>
                                    <div class="col-md-9">
                                        <input type="text" name="id" class="form-control" value="<?=$srno?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">IPD Number</label>
                                    <div class="col-md-9">
                                        <input type="text" name="ipd_number" value="<?=$ipd_number?>" class="form-control" placeholder="KOJF34"  />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="datepicker-default" name="date_of_addmission" type="text" class="form-control" placeholder="Default input" />
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Prefered Doctor</label>
                                    <div class="col-md-9">
                                        <input type="text" name="prefered_doctor" class="form-control" placeholder="Default input" />
                                    </div>
                                </div>
                                <div class="form-group">
