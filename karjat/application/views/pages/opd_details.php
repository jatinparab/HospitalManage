                        ...
                        <div class="panel-body">
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <?php foreach($opd as $entry){ ?>
                                    ...
                                    <?php } ?>
                                    <?php  ?>
                                    <td><a href="<?=base_url()?>opd/edit/<?=$entry['id']?>" class="btn-xs btn btn-info" >Add</a><br><a href="<?=base_url()?>opd/billing/<?=$entry['id']?>" class="m-t-10 btn btn-success btn-xs" >Billing</a></td>
                                    </tr>
                                <? }?>
                                </tbody>
                            </table>
