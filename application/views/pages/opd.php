...
?>	
    ...
    <!-- end theme-panel -->
		<div id="content" class="content">
			<!-- begin page-header -->
			<h1 class="page-header">OPD Table</h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">OPD Table</h4>
                        </div>
                        <div class="panel-body">
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php foreach($opd_records as $records) {
                                      echo "<tr><td> $records->patient_name </td><td> $records->age </td><td> $records->sex </td><td> $records->diagnosis </td><td> $records->remarks </td></tr>";
                                      }?>
                                </tbody>
                            </table>
                        </div>
