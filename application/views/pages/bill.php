...
<div id="print1" class="container" style="margin-top:100px;background-color:#fff;padding:25px;margin-bottom:100px;">
<div class="row pad-top-botm ">
         <div class="col-lg-6 col-md-6 col-sm-6 ">
            <img src="https://via.placeholder.com/300x150" class="img-responsive hideit"/> 
         </div>
