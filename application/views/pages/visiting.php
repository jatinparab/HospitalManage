                    ...
                    <div class="pan el panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="pan el-body">
                            ...
                            <div class="form-group">
									...
									<div class="col-md-9">
									    <input class="form-control"  name="ipd_number" value="<?=$_GET['ipd_number']?>" type="text" >
									</div>
								</div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Doctor Name</label>
                                    <div class="col-md-9">
                                        <input type="text" value='Dr. ' name="doctor_name" class="form-control onlytext" placeholder="Dr. 	" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="col-sm-3">
                                        <input  type="number" id="amount" oninput="calc_tot()" name="amount" class="form-control" placeholder="Amount" />
                                        ...
                                        <div class="col-sm-3">
                                        <input type="number" id="days" name="days" oninput="calc_tot()" class="form-control col-sm-6" placeholder="Days" />

                                        </div>
                                        <div class="col-sm-3">
                                        <input type="number" name="total" id="total" class="form-control col-sm-6" placeholder="Total"  disabled/>
