                        ...
                        <div class="panel-body">
                            <table id="data-table" class="table table-striped table-bordered">
                                <thead>
                                    ...
                                    <tr>
                                        <th>Sr. No</th>
                                        <th>Receipt Number / IPD Number</th>
                                        <th>Patient Name</th>
                                ...
                                <?php foreach($opd as $entry){ ?>
                                    ...
                                    <td><a href="<?=base_url()?>opd/billing/<?=$entry['id']?>" class="btn btn-info" >Generate Bill</a></td>
                                    </tr>
                                <? }?>
                                ...
                                <?php foreach($ipd as $entry){ ?>
                                    ...
                                    <td><a href="<?=base_url()?>ipd/billing/<?=$entry['ipd_number']?>" class="btn btn-info" >Generate Bill</a></td>
                                    </tr>
                                <? }?>
                                </tbody>
                            </table>
